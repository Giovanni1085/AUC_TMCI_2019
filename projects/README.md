...
* **November 15** Project update 0: GitHub repository `README` (or a Google doc). You need here to submit a link to your repo containing the populated `README` file. This file should contain a detailed project plan, including: research question, dataset, methods, milestones, proposed division of work.
...
* **December 17-20** In-class presentations (10% of final grade): 10+10 minutes (presentation + questions).
...
4. [Default project ideas](default_project_ideas)
5. Example projects (from other courses!)
